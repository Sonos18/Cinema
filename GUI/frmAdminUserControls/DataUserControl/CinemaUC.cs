...
namespace GUI.frmAdminUserControls.DataUserControl
{
    public partial class CinemaUC : UserControl
    {
        ...
        void LoadCinemaList()            //Lay list cac phong chieu
        {
        ...
        //liên kết dữ liệu giữa dtgv và cbo vì cbo không thể được áp dụng DataBindings bình thường
        {
            ...
            //Loai man hinh dang chon trong datagridview
